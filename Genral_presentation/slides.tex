...
\begin{frame}{Method: Modeling Performance based on Grain Size}
	\begin{outline}	
		\begin{figure}[H]
			\centering
			\subfloat[1 core]{\includegraphics[scale=.3]{images/polyfit/fig_1_690.png}\label{fig10:a}}
			\subfloat[2 cores]{\includegraphics[scale=.3]{images/polyfit/fig_2_690.png}\label{fig10:b}}\hfill
%			\subfloat[3 cores]{\includegraphics[scale=.18]{images/polyfit/fig_3_690.png}\label{fig10:c}}{\hfill}
			\subfloat[4 cores]{\includegraphics[scale=.3]{images/polyfit/fig_4_690.png}\label{fig10:d}}
...
%			\subfloat[7 cores]{\includegraphics[scale=.18]{images/polyfit/fig_7_690.png}\label{fig10:g}}
			\subfloat[8 cores]{\includegraphics[scale=.3]{images/polyfit/fig_8_690.png}\label{fig10:h}}
...
%		\begin{figure}[H]
%			\centering
%			\subfloat[1 core]{\includegraphics[scale=.15]{images/polyfit/fig_1_690.png}\label{fig40:a}}
%			\subfloat[2 cores]{\includegraphics[scale=.15]{images/polyfit/fig_2_690.png}\label{fig40:b}}
%			\subfloat[3 cores]{\includegraphics[scale=.15]{images/polyfit/fig_3_690.png}\label{fig40:c}}
%			\subfloat[4 cores]{\includegraphics[scale=.15]{images/polyfit/fig_4_690.png}\label{fig40:d}}{\hfill}
%			\subfloat[5 cores]{\includegraphics[scale=.15]{images/polyfit/fig_5_690.png}\label{fig40:e}}
%			\subfloat[6 cores]{\includegraphics[scale=.15]{images/polyfit/fig_6_690.png}\label{fig40:f}}
%			\subfloat[7 cores]{\includegraphics[scale=.15]{images/polyfit/fig_7_690.png}\label{fig40:g}}
%			\subfloat[8 cores]{\includegraphics[scale=.15]{images/polyfit/fig_8_690.png}\label{fig40:h}}
%			
...
\begin{frame}{Method: Modeling Performance based on Grain Size}
	\begin{outline}
		\begin{figure}[H]
			\centering
			\subfloat[]{\includegraphics[scale=.32]{images/polyfit/fig_690_total_error_r2.png}\label{fig17:a}}
			\subfloat[]{\includegraphics[scale=.32]{images/polyfit/fig_690_total_error_mae.png}\label{fig17:b}}
...
\begin{frame}{Method: Modeling Performance based on Grain Size}
	\begin{outline}
		\begin{figure}[H]
			...
			\subfloat[]{\includegraphics[scale=.32]{images/bathtub/error_690mae.png}\label{fig38:b}}
