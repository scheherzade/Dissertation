...
\begin{frame}{Method: Modeling Performance based on Grain Size}
	\begin{outline}	
		\begin{figure}[H]
			...
			\subfloat[2 cores]{\includegraphics[scale=.18]{images/polyfit/fig_2_690.png}\label{fig10:b}}
...
\begin{frame}{Method: Modeling Execution Time based on Grain Size}
	...
	\begin{figure}[H]
		\centering
		\subfloat[]{\includegraphics[scale=.2]{images/bathtub/coef_1_690.png}\label{fig24:a}}
		\subfloat[]{\includegraphics[scale=.2]{images/bathtub/coef_2_690.png}\label{fig24:b}}\hfill	
		\subfloat[]{\includegraphics[scale=.2]{images/bathtub/coef_3_690.png}\label{fig24:c}}
