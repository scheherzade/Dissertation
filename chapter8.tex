...
\begin{figure}[H]
	\centering
	\subfloat[]
	{\centering\includegraphics[scale=.4]{images/hpx_for_loop/blazemark/100000/marvin_pred_690_1.png}	
		\label{fig52:a}}
	\subfloat[]
...
\begin{figure}[H]
	...
	\label{fig56:g}}
	\caption{The results of predicted values of execution time through curve fitting vs the real data for with $matrix\_size=$, for (a) 690, (b) 912, (c) 1825, (d) 3193, (e) 4222, (f) 4855, (g) 6420, on 8 cores, with $\lambda_{s}=0.01$ and $\lambda_{b}=0.5$. The unit for execution time is microseconds.}
	\label{fig56}	
\end{figure}
